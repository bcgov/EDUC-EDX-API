...
EMAIL_TEMPLATE_EDX_DISTRICT_USER_ACTIVATION_INVITE_LITERAL="<!DOCTYPE html><html xmlns:th=\"http://www.thymeleaf.org\"><head><meta charset=\"ISO-8859-1\"><title>Edx District User Activation</title></head><body>Hi <span th:text=\"\${$}{recipient}\"></span>,<br><br>Thank you for completing step 1 and registering your district’s Microsoft tenant ID with the ministry (<span th:text=\"\${$}{districtName}\"></span>).<br><br>You’re now ready for step 2 and activating your EDX account.  <ol><li>Access <a th:href=\"@{\${\$}{activationLink}}\">EDX</a></li><li>Choose Microsoft as your registration option</li><li>Log into your Microsoft account</li><li>Enter your district’s primary activation code, which will come in a separate email</li><li>Enter your Personal Activation Code: <span th:text=\"\${$}{personalActivationCode}\"></span></li></ol>Please activate your account as soon as you receive this email. This will help the ministry monitor EDX’s early performance. Onboarding of schools and other district users can occur in January.<br><br><b>Terms of Use</b><br><br>Each EDX user must have their own log in credential. Sharing of passwords is prohibited to protect student privacy. Read the complete <a th:href=\"https://www2.gov.bc.ca/gov/content/education-training/k-12/administration/program-management/data-collections/education-data-exchange-engagement#Termsofuse">terms of use</a>.<br><br><b>Activation Help</b><br><br>If you’re unable to activate your account, please email educationdataexchange@gov.bc.ca.<br><br><b>Resources and Updates</b><br><br>Subscribe to the <a th:href=\"https://www2.gov.bc.ca/gov/content/education-training/k-12/administration/program-management/data-collections/education-data-exchange-engagement">EDX info hub</a><br><br><br><b>The EDX Team</b><br>Ministry of Education and Child Care<br>educationdataexchange@gov.bc.ca</body></html>"
