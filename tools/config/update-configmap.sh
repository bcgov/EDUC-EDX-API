...
ROLES_ALLOW_LIST="EDX_DISTRICT_ADMIN,EDX_SCHOOL_ADMIN,STUDENT_DATA_COLLECTION,SECURE_EXCHANGE_SCHOOL,SECURE_EXCHANGE_DISTRICT,EDX_EDIT_SCHOOL,EDX_EDIT_DISTRICT,SCHOOL_SDC,DISTRICT_SDC,SUPERINT,SECR_TRES,DIS_SDC_RO,SCH_SDC_RO,GRAD_SCH_ADMIN,GRAD_DIS_ADMIN,EAS_SCH_ADMIN,EAS_DIS_ADMIN"
...
SCHEDULED_JOBS_UPDATE_USER_ROLE_FOR_CLOSED_SCHOOL_CRON="0 0/5 * * * *"
