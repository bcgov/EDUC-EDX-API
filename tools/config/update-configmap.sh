...
[PARSER]
    ...
    Format      json
"
EMAIL_TEMPLATE_EDX_SCHOOL_USER_ACTIVATION_INVITE_LITERAL="<!DOCTYPE html><html xmlns:th=\"http://www.thymeleaf.org\"><head><meta charset=\"ISO-8859-1\"><title>Edx School User Activation</title></head><body>Hi <span th:text=\"\${$}{firstName}\"></span>,<br><br><span th:text=\"\${$}{schoolName}\"></span> would like to invite you to use the Education Data Exchange (EDX).<br><br>To activate your access you will need:<ol><li>A Basic BCeID account - you can create one here if needed: <a th:href=\"https://www.bceid.ca/\">https://www.bceid.ca/</a>,</li><li>The school's Primary Activation Code - available from the EDX administrator(s) for your school: @{\${\$}{edxAdmins}}></li><li>Your Personal Activation Code - provided below</li></ol>When you are have a Basic BCeID account and the Primary Activation Code you are ready to get started!<br><br><b>Steps to Activate your Access</b><ol><li>Access <a th:href=\"@{\${\$}{activationLink}}\">EDX</a></li><li>Enter your Basic BCeID username and password</li><li>Enter the school's Primary Activation Code</li><li>Enter your Personal Activation Code: <span th:text=\"\${$}{personalActivationCode}\"></span></li></ol><br><br>If the above link doesn't work, please paste this link into your web browser's address field:<br><br><a th:href=\"@{\${\$}{activationLink}}\" th:text=\"\${\$}{activationLink}\"></a><br><br>Regards,<br>The Ministry of Education and Child Care's EDX Team</body></html>"

EMAIL_TEMPLATE_EDX_DISTRICT_USER_ACTIVATION_INVITE_LITERAL="<!DOCTYPE html><html xmlns:th=\"http://www.thymeleaf.org\"><head><meta charset=\"ISO-8859-1\"><title>Edx District User Activation</title></head><body>Hi <span th:text=\"\${$}{firstName}\"></span>,<br><br><span th:text=\"\${$}{districtName}\"></span> would like to invite you to use the Education Data Exchange (EDX).<br><br>To activate your access please complete the following steps:<ol><li>Access EDX via this link: <a th:href=\"@{\${\$}{activationLink}}\">here</a></li><li>Log into EDX using the credential of your choice.</li><li>Enter the following information:<dd>- The district number for <span th:text=\"\${$}{districtName}\"></span></dd><dd>- The districts's Primary Activation Code (this can be obtained from your district administrator)</dd><dd>- Your Personal Activation Code: <span th:text=\"\${$}{personalActivationCode}\"></span></dd></li></ol><br><br>If the above link doesn't work, please paste this link into your web browser's address field:<br><br><a th:href=\"@{\${\$}{activationLink}}\" th:text=\"\${\$}{activationLink}\"></a><br><br>Regards,<br>The Ministry of Education and Child Care's EDX Team</body></html>"

EMAIL_TEMPLATE_EDX_NEW_SECURE_EXCHANGE_NOTIFICATION_LITERAL="<!DOCTYPE html><html xmlns:th=\"http://www.thymeleaf.org\"><head><meta charset=\"ISO-8859-1\"><title> New Secure Exchange Message</title></head><body>Hi there,<br><br><span th:text=\"\${$}{schoolName}\"></span> has received a new secure message from the <span th:text=\"\${$}{ministryTeamName}\"></span>.<br><br>To view the message, please log into the Education Data Exchange: <a th:href=\"@{\${\$}{linkToEDX}}\">here</a><br><br>If the above link doesn't work, please paste this link into your web browser's address field:<br><br><a th:href=\"@{\${\$}{linkToEDX}}\" th:text=\"\${\$}{linkToEDX}\"></a><br><br>Regards,<br>The Ministry of Education and Child Care's EDX Team</body></html>"

EMAIL_TEMPLATE_EDX_SECURE_EXCHANGE_COMMENT_NOTIFICATION_LITERAL="<!DOCTYPE html><html xmlns:th=\"http://www.thymeleaf.org\"><head><meta charset=\"ISO-8859-1\"><title>Message Added to Secure Exchange</title></head><body>Hi there,<br><br>The <span th:text=\"\${$}{ministryTeamName}\"></span> has added a new message to secure message #<span th:text=\"\${$}{messageSequenceNumber}\"></span> for <span th:text=\"\${$}{schoolName}\"></span>.<br><br>To view the message, please log into the Education Data Exchange: <a th:href=\"@{\${\$}{linkToEDX}}\">here</a><br><br>If the above link doesn't work, please paste this link into your web browser's address field:<br><br><a th:href=\"@{\${\$}{linkToEDX}}\" th:text=\"\${\$}{linkToEDX}\"></a><br><br>Regards,<br>The Ministry of Education and Child Care's EDX Team</body></html>"
