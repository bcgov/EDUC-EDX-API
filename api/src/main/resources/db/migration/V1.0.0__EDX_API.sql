...
(
    EDX_PERMISSION_CODE VARCHAR(30)         NOT NULL,
    ...
    UPDATE_USER         VARCHAR(32)         NOT NULL,
    UPDATE_DATE         TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    CONSTRAINT EDX_PERMISSION_CODE_PK PRIMARY KEY (EDX_PERMISSION_CODE)
);
...
(
    ...
    EDX_ROLE_CODE          VARCHAR(30)         NOT NULL,
    EDX_PERMISSION_CODE    VARCHAR(30)         NOT NULL,
    CREATE_USER            VARCHAR(32)         NOT NULL,
    CREATE_DATE            TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    UPDATE_USER            VARCHAR(32)         NOT NULL,
...
(
    EDX_ROLE_CODE      VARCHAR(30)         NOT NULL,
    LABEL              VARCHAR(30)         NOT NULL,
    IS_DISTRICT_ROLE   BOOLEAN             NOT NULL,
    DESCRIPTION        VARCHAR(255)        NOT NULL,
    CREATE_USER        VARCHAR(32)         NOT NULL,
    CREATE_DATE        TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    UPDATE_USER        VARCHAR(32)         NOT NULL,
    UPDATE_DATE        TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    CONSTRAINT EDX_ROLE_CODE_PK PRIMARY KEY (EDX_ROLE_CODE)
);
...
ALTER TABLE EDX_ROLE_PERMISSION
    ADD CONSTRAINT FK_EDX_ROLE_PERMISSION_EDX_ROLE_CODE FOREIGN KEY (EDX_ROLE_CODE) REFERENCES EDX_ROLE (EDX_ROLE_CODE);
ALTER TABLE EDX_ROLE_PERMISSION
    ADD CONSTRAINT FK_EDX_ROLE_PERMISSION_EDX_PERMISSION_CODE FOREIGN KEY (EDX_PERMISSION_CODE) REFERENCES EDX_PERMISSION (EDX_PERMISSION_CODE);
...
ALTER TABLE EDX_USER_DISTRICT_ROLE
    ADD CONSTRAINT FK_EDX_USER_DISTRICT_ROLE_EDX_ROLE_CODE FOREIGN KEY (EDX_ROLE_CODE) REFERENCES EDX_ROLE (EDX_ROLE_CODE);
...
ALTER TABLE EDX_USER_SCHOOL_ROLE
    ADD CONSTRAINT FK_EDX_USER_SCHOOL_ROLE_EDX_ROLE_CODE FOREIGN KEY (EDX_ROLE_CODE) REFERENCES EDX_ROLE (EDX_ROLE_CODE);

ALTER TABLE EDX_ACTIVATION_ROLE
    ADD CONSTRAINT FK_EDX_ACTIVATION_ROLE_EDX_ROLE_CODE FOREIGN KEY (EDX_ROLE_CODE) REFERENCES EDX_ROLE (EDX_ROLE_CODE);
ALTER TABLE EDX_ACTIVATION_ROLE
