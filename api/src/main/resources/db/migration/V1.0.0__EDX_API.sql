...
(
    ...
    SECURE_EXCHANGE_CONTACT_TYPE_CODE VARCHAR2(10)         NOT NULL,
    EDX_MINISTRY_OWNERSHIP_TEAM_ID    UUID                 NOT NULL,
    CONTACT_IDENTIFIER                VARCHAR2(255),
...
(
    EDX_ROLE_ID      UUID                 NOT NULL,
    NAME             VARCHAR2(30)         NOT NULL,
    IS_DISTRICT_ROLE VARCHAR2(1)          NOT NULL,
    DESCRIPTION      VARCHAR2(255)        NOT NULL,
    CREATE_USER      VARCHAR2(32)         NOT NULL,
    CREATE_DATE      DATE DEFAULT SYSDATE NOT NULL,
    UPDATE_USER      VARCHAR2(32)         NOT NULL,
...
(
    ...
    SECURE_EXCHANGE_ID         UUID                 NOT NULL,
    EDX_USER_ID                UUID,
    STAFF_USER_IDENTIFIER      VARCHAR2(255),
    COMMENT_USER_NAME          VARCHAR2(255)        NOT NULL,
...
(
    ...
    SECURE_EXCHANGE_ID      UUID                 NOT NULL,
    STAFF_USER_IDENTIFIER   VARCHAR2(255)        NOT NULL,
